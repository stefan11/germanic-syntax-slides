...
\input{geteilte-Folien/argumente-adjunkte.tex}
...
\item Verb bildet zusammen mit den Komplementen eine Phrase (VP = \comps \sliste{}).
...
Specifier-Head Schema and Head-Complement Schema (vorläufig)
\begin{tabular}[t]{@{}l@{ }l@{}}
...
Specifier-Head Schema und Head-Complement Schema (endgültig)
\begin{tabular}[t]{@{}l@{~}l@{ }l@{}}
...
\subsection{Scrambling und freie VO/OV-Stellung}
...
\item Beantworten Sie die Quick questions im Buch und lesen Sie nach,\\
      wenn Sie dazu nicht in der Lage sein sollten.
