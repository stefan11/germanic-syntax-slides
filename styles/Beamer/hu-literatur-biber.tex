...
%\section{\refname} % is needed since otherwise a subsection information is shown on the very last
                    % slide. 26.06.2025
...
%\iflanguage{german}{\def\insertsectionhead{Literatur}}{\def\insertsectionhead{\refname}}
