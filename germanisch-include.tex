...
%\include{organisatorisches-syntax-vl-ba-hu}
\include{germanisch-ueberblick}
%% \include{germanisch-deutsch}
%% \include{germanisch-niederlaendisch}
%% \include{germanisch-englisch}
%% \include{germanisch-afrikaans}
%% \include{germanisch-schwedisch}
%% \include{germanisch-islaendisch}
