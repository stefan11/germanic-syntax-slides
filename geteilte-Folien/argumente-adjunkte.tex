...
% \frame[shrink]{
% \frametitle{Achtung, Achtung!}

% Bei der Einordnung von Argumenten und Adjunkten geht immer wieder was schief.
% \begin{itemize}
% \item Adjunkt $\rightarrow$ optional
% \item optional $\nrightarrow$ Adjunkt
% \item kein Adjunkt $\leftarrow$ nicht optional
% \item falsch: Argument $\rightarrow$ nicht optional 
% \item falsch: Argument $\rightarrow$ obligatorisch
% %\item falsch: 
% \end{itemize}

% \begin{itemize}
% \item Argument $\nrightarrow$ obligatorisch
% \item Argument $\leftarrow$ obligatorisch
% \item obligatorisch $\rightarrow$ Argument
% \end{itemize}

% \begin{itemize}
% \item Die Eigenschaft, obligatorisch zu sein, ist hinreichend für den Argumentstatus.
% (Wenn ein Element obligatorisch ist, muss es ein Argument sein. Ein Argument muss nicht
% obligatorisch sein. Wenn ein Element nicht obligatorisch ist, kann es prinzipiell Argument oder
% Adjunkt sein.)

% \item Die Eigenschaft, fakultativ zu sein, ist notwendig für den Adjunktstatus.
% (Wenn ein Element ein Adjunkt ist, muss es fakultativ sein. Wenn es nicht fakultativ ist, kann es
% kein Adjunkt sein.)
% \end{itemize}
