...
\begin{forest}
sm edges
[{S \eliste},visible on=5-
  [{NP[\type{nom}]},visible on=4- 
    [niemand,visible on=4-] ]
  [{V$'$\sliste{ NP[\type{nom}] } },visible on=3-
    [{NP[\type{acc}]} [ihn] ]
...
\item Diese sind aber nicht einfach da. Es gibt Regeln oder Schemata, die sie lizenzieren.
...
\eal
\ex {}[a [picture [of Kim]]]
\ex {}[The dolphin [attacked [the shark]]]
\zl
