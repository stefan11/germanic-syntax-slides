...
\item Einführungsbuch zur HPSG: \citew{MuellerLehrbuch}
...
\frame{
\frametitle{Veranstaltungsart: Vorlesung}


\begin{itemize}
\item Diese Veranstaltung ist eine Vorlesung.
\item Das bedeutet Frontalunterricht. (Jemand liest etwas vor.)
\item Sie können jederzeit unterbrechen und Fragen stellen.
\item Es wird keine oder nur selten Übungen geben.
\item Bilden Sie Lerngruppen!
\item Gehen Sie zum Tutorium. Das ist für den Übungsteil da.
\item Fragen Sie.\\
(Sie können darüber zu einem gewissen Grad das Tempo steuern. Das setzt jedoch
  Vor- und Nachbereitung voraus.)
\end{itemize}
...
\begin{itemize}
\item Zu jedem Kapitel gibt es am Ende Übungsaufgaben.
\item Diese Übungsaufgaben entsprechen möglichen Klausuraufgaben.
\item Am Ende des Buches gibt es die Lösungen der Aufgaben.
\item Auf der Web-Seite zu dieser Vorlesung gibt es Klausuraufgaben aus den vergangenen Semestern.

\url{https://hpsg.hu-berlin.de/~stefan/Lehre/Germanisch/}

\item Für den Syntax-Teil der Klausur können Sie 40 Punkte bekommen,\\
      für den Semantik-Teil 60.
