...
Zu diesem Abschnitt gibt es das Kapitel~7 in \citew{MuellerGermanic}.
...
\gll Hvenær hafði \gruen{Sigga}        hjálpað \rot{Haraldi}?\\
     wann   hat   Sigga.\NOM{} geholfen Harald.\DAT{}\\\jambox{(W-Frage)}
}
\ex[*]{
...
\gll \rot{Haraldi}       hafði \gruen{Sigga}        aldrei hjálpað.\\
     Harald.\DAT{} hat   Sigga.\NOM{} nie    geholfen\\\jambox{(V2-Satz)}
}
\z
...
Bei Passivierung der Verben ergeben sich die folgenden \argst"=Listen für \emph{wird}:
\ea
\begin{tabular}[t]{@{}l@{~}l@{~}l}
a. & \emph{geschlafen wird}:  & \argst \sliste{ V }\\
b. & \emph{unterstützt wird}: & \argst \sliste{ NP[\type{str}]$_j$, V }\\
c. & \emph{geholfen wird}:    & \argst \sliste{ NP[\type{ldat}]$_j$, V }\\
d. & \emph{geschenkt wird}:   & \argst \sliste{ NP[\type{ldat}]$_j$, NP[\type{str}]$_k$, V }\\
\end{tabular}
\z
...
\gll Konunginum voru gefnar ambáttir.\\
     König.\DAT{} wurden gegeben.\fem.\PL{} Sklavinnen.\NOM.\fem.\PL\\\jambox{[S$_i$ Aux \_$_i$ V O]} 
...
\gll Ambáttin var gefin konunginum.\\
     Sklavin.\NOM.\SG{}  wurde gegeben.\fem.\SG{} König.\DAT\\\jambox{[S$_i$ Aux \_$_i$ V O]} 
...
\frame[shrink=10]{
\frametitle{Alle Komplemente des Partizips können vorangestellt werden}
...
\input{germanisch-aufgaben-uebungen}
